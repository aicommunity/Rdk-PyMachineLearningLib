...
// абстрактный базовый класс "учителей" сеток разных типов
...
ULProperty<std::vector<float>, TPyBaseTrainer> SplitRatio;
...
// при запуске обучения и других ситуациях, когда нельзя обучать флаг StartTraining становится false
